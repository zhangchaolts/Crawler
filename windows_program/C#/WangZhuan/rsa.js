var navigator = {
	appCodeName : "Mozilla", appMinorVersion : "0", browserLanguage : "zh-cn", cookieEnabled : true
};
...
function pkcs1pad2(e, t) {
	if (t < e.length + 2) return alert("ÃÜÂëÌ«³¤!"), null;
	var n = new Array,
		r = e.length - 1,
		i = e.length;
	if (i < 100) {
		...
		var s = 2;
		r = 0;
		while (r < i && t > 0) n[s++] = e.charCodeAt(r++);
...
function liuhjtest() {
	var e = "",
		t = new RSAKey;
	t.setPublic(e, "10001");
...
function fastEncrypt(txt, key, exp) {
	var e = new RSAKey;
	e.setPublic(key, exp);
	var t = e.encrypt(txt);
	return t;
